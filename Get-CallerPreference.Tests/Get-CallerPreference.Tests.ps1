Remove-Module Get-CallerPreference -ErrorAction SilentlyContinue
Import-Module ..\Get-CallerPreference
Remove-Module Get-CallerPreference.Tests.Util -ErrorAction Continue
Import-Module .\Get-CallerPreference.Tests.Util.psm1
